...
const (
	...
	GetAssignmentFromCourseID MoodleEnum = "http://103.13.207.85/webservice/rest/server.php?wstoken=%s&wsfunction=mod_assign_get_assignments&moodlewsrestformat=json&courseids[0]=%s"

...
const (
	...
	GetAssignmentFromCourseID MoodleEnum = "http://103.13.207.85/webservice/rest/server.php?wstoken=%s&wsfunction=mod_assign_get_assignments&moodlewsrestformat=json&courseids[0]=%d"
	GetQuizFromCourseID       MoodleEnum = "http://103.13.207.85/webservice/rest/server.php?wstoken=%s&wsfunction=mod_quiz_get_quizzes_by_courses&moodlewsrestformat=json&courseids[0]=%d"
)

module projects-subscribeme-backend
...
require (
	...
	github.com/deepaksinghvi/cdule v1.0.12 // indirect
	...
	github.com/tssaini/go-agenda v0.0.0-20200810051219-9d067cb15d8f // indirect
